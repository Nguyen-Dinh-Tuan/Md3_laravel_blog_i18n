...
Route::get('search', [\App\Http\Controllers\SearchController::class,'getSearch']);
Route::post('search/name', [\App\Http\Controllers\SearchController::class, 'getSearchAjax'])->name('search');
